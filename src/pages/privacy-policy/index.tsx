...
const PrivacyPolicy: React.FC = () => {
  return (
    <Stack display="flex" direction="column">
      ...
      <Stack>
        <p>
          Talents (“we,” “our,” or “us”) is committed to protecting your
          privacy. This Privacy Policy explains how your personal information is
          collected, used, and disclosed by Talents.
        </p>
        <p>
          ...
          Talents. By accessing or using our Service, you signify that you have
      ...
      <Stack>
        ...
        <ul>
          ...
          <li>
            ...
            in this case is Brasil
          </li>
          <li>
            Customer: refers to the company, organization or person that signs
            up to use the Talents Service to manage the relationships with your
          ...
          <li>
            Personnel: refers to those individuals who are employed by Talents
      ...
      <Stack>
        <h2>When does Talents use end user information from third parties?</h2>
        <p>
          Talents will collect End User Data necessary to provide the Talents
      ...
      <Stack>
        <h2>When does Talents use customer information from third parties?</h2>
        <p>
          ...
          interest in becoming a Talents customer, we receive information from a
          third party that provides automated fraud detection services to
          Talents. We also occasionally collect information that is made
      ...
      <Stack>
        ...
        <p>
          Talents will collect personal information that you submit to us. We
      ...
      <Stack>
        ...
        <p>
          We keep your information only so long as we need it to provide Talents
      ...
      <Stack>
        ...
        <p>
          ...
          absolute security of any information you transmit to Talents or
      ...
      <Stack>
        ...
        <p>
          Talents is incorporated in Brasil. Information collected via our
      ...
      <Stack>
        <h2>
          Is the information collected through the Talents Service secure?
        </h2>
        <p>
      ...
      <Stack>
        ...
        <p>
          ...
          information Talents collects depend on your relationship with Talents.
      ...
      <Stack>
        <h2>Personnel</h2>
        <p>
          If you are a Talents worker or applicant, we collect information you
      ...
      <Stack>
        ...
        <p>
          ...
          of the assets of Talents or any of its Corporate Affiliates (as
          defined herein), or that portion of Talents or any of its Corporate
      ...
      <Stack>
        ...
        <p>
          ...
          Talents, whether by ownership or otherwise. Any information relating
      ...
      <Stack>
        ...
        <p>
          The laws of Brasil, excluding its conflicts of law rules, shall govern
        ...
        <p>
          By using Talents or contacting us directly, you signify your
      ...
      <Stack>
        ...
        <p>
          ...
          orientation, and ethnicity.Any data that relates to an identifiable or
          identified individual. GDPR covers a broad spectrum of information
          that could be used on its own, or in combination with other pieces of
          information, to identify a person. Personal data extends beyond a
          person’s name or email address. Some examples include financial
      ...
      <Stack>
        ...
        <p>
          ...
          right thing to do. At Talents we strongly believe that your data
      ...
      <Stack>
        ...
        <p>
          ...
          requirements of GDPR. Talents processes or stores all personal data in
