  ...
  return (
    <Stack display="flex" direction="column">
      <Stack display="flex" direction="column" alignItems="center">
        ...
        <p>Updated at 2023-07-24</p>
      </Stack>
      <Stack>
        <h2>General Terms</h2>
        <p>
          By accessing and placing an order with Talents, you confirm that you
        ...
        <p>
          Under no circumstances shall Talents team be liable for any direct,
          ...
          inability to use, the materials on this site, even if Talents team or
        ...
        <p>
          Talents will not be responsible for any outcome that may occur during
      ...
      <Stack>
        <h2>License</h2>
        <p>
          Talents grants you a revocable, non-exclusive, non-transferable,
          limited license to download, install and use the website strictly in
          accordance with the terms of this Agreement.
        </p>
        <p>
          These Terms & Conditions are a contract between you and Talents
          (referred to in these Terms & Conditions as "Talents", "us", "we" or
          "our"), the provider of the Talents website and the services
          accessible from the Talents website (which are collectively referred
          to in these Terms & Conditions as the "Talents Service").
        </p>
        <p>
          You are agreeing to be bound by these Terms & Conditions. If you do
          not agree to these Terms & Conditions, please do not use the Talents
      ...
      <Stack>
        ...
        <ul>
          ...
          <li>
            ...
            it refers to Devbox LTDA, R JOSE ADERVAL CHAVES, 78, SALA 0508 EDF
            WECON EMP CENTER IV, BOA VIAGEM, RECIFE-PE, CEP 51.111-030 that is
            responsible for your information under this Terms & Conditions.
          </li>
          <li>
            Country: where Talents or the owners/founders of Talents are based,
            in this case is
          </li>
          <li>
            Device: any internet connected device such as a phone, tablet,
            computer or any other device that can be used to visit Talents and
            use the services.
          </li>
          <li>
            Service: refers to the service provided by Talents as described in
          ...
          <li>
            Website: Talents's site, which can be accessed via this URL:
            https://talents.devbox.eng.br
          </li>
          <li>
            You: a person or entity that is registered with Talents to use the
            Services.
          </li>
        </ul>
      </Stack>
      <Stack>
        ...
        <ul>
          ...
          <li>
            ...
            notice of copyright or trademark) of Talents or its affiliates,
      ...
      <Stack>
        ...
        <p>
          Thanks for shopping at Talents. We appreciate the fact that you like
        ...
        <p>
          ...
          apply to transactions at Talents. We’ll be as brief as our attorneys
          will allow. The main thing to remember is that by placing an order or
          making a purchase at Talents, you agree to the terms along with
          Talents's Privacy Policy.
        </p>
        <p>
      ...
      <Stack>
        ...
        <p>
          ...
          (collectively, "Suggestions") provided by you to Talents with respect
          to the website shall remain the sole and exclusive property of
          Talents.
        </p>
        <p>
          Talents shall be free to use, copy, modify, publish, or redistribute
      ...
      <Stack>
        ...
        <p>
          ...
          contain links to other websites not operated or controlled by Talents.
      ...
      <Stack>
        <h2>Cookies</h2>
        <p>
          Talents uses "Cookies" to identify the areas of our website that you
      ...
      <Stack>
        ...
        <p>
          You acknowledge and agree that Talents may stop (permanently or
          ...
          do not need to specifically inform Talents when you stop using the
          Service. You acknowledge and agree that if Talents disables access to
      ...
      <Stack>
        ...
        <p>
          Talents reserves the right to modify, suspend or discontinue,
      ...
      <Stack>
        ...
        <p>
          Talents may from time to time provide enhancements or improvements to
        ...
        <p>
          ...
          of the website. You agree that Talents has no obligation to (i)
      ...
      <Stack>
        ...
        <p>
          You acknowledge and agree that Talents shall not be responsible for
          ...
          or any other aspect thereof. Talents does not assume and shall not
      ...
      <Stack>
        ...
        <p>
          Talents may, in its sole discretion, at any time and for any or no
        ...
        <p>
          ...
          Talents, in the event that you fail to comply with any provision of
        ...
        <p>
          Termination of this Agreement will not limit any of Talents's rights
      ...
      <Stack>
        ...
        <p>
          You agree to indemnify and hold Talents and its parents, subsidiaries,
      ...
      <Stack>
        ...
        <p>
          ...
          permitted under applicable law, Talents, on its own behalf and on
          ...
          trade practice. Without limitation to the foregoing, Talents provides
        ...
        <p>
          Without limiting the foregoing, neither Talents nor any Talents's
          ...
          the content, or e-mails sent from or on behalf of Talents are free of
      ...
      <Stack>
        ...
        <p>
          ...
          of Talents and any of its suppliers under any provision of this
        ...
        <p>
          ...
          Talents or its suppliers be liable for any special, incidental,
          ...
          provision of this Agreement), even if Talents or any supplier has been
      ...
      <Stack>
        ...
        <p>
          ...
          notices published by Talents on the Services, shall constitute the
          entire agreement between you and Talents concerning the Services. If
          ...
          term or any other term, and Talents's failure to assert any right or
          provision under this Agreement shall not constitute a waiver of such
          right or provision. YOU AND Talents AGREE THAT ANY CAUSE OF ACTION
      ...
      <Stack>
        ...
        <p>
          Talents reserves the right, at its sole discretion, to modify or
        ...
        <p>
          ...
          agree to the new terms, you are no longer authorized to use Talents.
        </p>
      </Stack>
      <Stack>
        <h2>Entire Agreement</h2>
        <p>
          The Agreement constitutes the entire agreement between you and Talents
          regarding your use of the website and supersedes all prior and
          contemporaneous written or oral agreements between you and Talents.
        </p>
        <p>
          You may be subject to additional terms and conditions that apply when
          you use or purchase other Talents's services, which Talents will
      ...
      <Stack>
        ...
        <p>
          ...
          arrangement thereof), are owned by Talents, its licensors or other
          ...
          or in part, without the express prior written permission of Talents,
      ...
      <Stack>
        ...
        <p>
          ...
          REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR Talents's
          INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any dispute,
          action, or other controversy between you and Talents concerning the
      ...
      <Stack>
        ...
        <p>
          In the event of a dispute, you or Talents must give the other a Notice
          ...
          any Notice of Dispute via email to: . Talents will send any Notice of
          Dispute to you by mail to your address if we have it, or otherwise to
          your email address. You and Talents will attempt to resolve any
          ...
          Talents may commence arbitration.
        </p>
      </Stack>
      <Stack>
        <h2>Binding Arbitration</h2>
        <p>
          If you and Talents don’t resolve any dispute by informal negotiation,
      ...
      <Stack>
        ...
        <p>
          ...
          and will become the sole property of Talents without any compensation
          or credit to you whatsoever. Talents and its affiliates shall have no
      ...
      <Stack>
        <h2>Promotions</h2>
        <p>
          Talents may, from time to time, include contests, promotions,
      ...
      <Stack>
        ...
        <p>
          ...
          representative of Talents. Talents will be entitled to injunctive or
          ...
          Talents operates and controls the Talents Service from its offices in
          ...
          who choose to access the Talents Service from other locations do so on
          ...
          Terms & Conditions (which include and incorporate the Talents Privacy
          Policy) contains the entire understanding, and supersedes all prior
          understandings, between you and Talents concerning its subject matter,
      ...
      <Stack>
        <h2>Disclaimer</h2>
        <p>
          Talents is not responsible for any content, code or any other
          imprecision.
        </p>
        <p>Talents does not provide warranties or guarantees.</p>
        <p>
          In no event shall Talents be liable for any special, direct, indirect,
        ...
        <p>
          The Talents Service and its contents are provided "as is" and "as
          available" without any warranty or representations of any kind,
          whether express or implied. Talents is a distributor and not a
          publisher of the content supplied by third parties; as such, Talents
          ...
          accessible via the Talents Service. Without limiting the foregoing,
          Talents specifically disclaims all warranties and representations in
          any content transmitted on or in connection with the Talents Service
          or on sites that may appear as links on the Talents Service, or in the
          products provided as a part of, or otherwise in connection with, the
          Talents Service, including without limitation any warranties of
          merchantability, fitness for a particular purpose or non-infringement
          of third party rights. No oral advice or written information given by
          Talents or any of its affiliates, employees, officers, directors,
          ...
          foregoing, Talents does not warrant that the Talents Service will be
      ...
      <Stack>
        ...
        <ul>
          <li>Via this Link: https://devbox.eng.br</li>
        </ul>
      </Stack>
